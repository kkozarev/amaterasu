...
/*============== Year labels ==============*/
            ...
            labels.selectAll("text")
                ...
                .style("font-size", segmentHeight + 'px').style('stroke','black')
                .text(function(d) {return d;});
/*=======================================*/


/*==================Month labels ==================*/
            var monthLabelOffset = segmentHeight/2.;
...
//	if (oldIR != 0.) {innerRad=oldIR};
	...
	var outerRad=segmentHeight/2.+spiralA+spiralB * endAng; //segmentHeight+
