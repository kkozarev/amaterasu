...
<head>
	...
	<!--
		...
		A {text-decoration:  color: #00a1d1;}
		A:active { text-decoration:  color: #00a1d1;}
		A:hover {text-decoration: underline; color: #00a1d1;}
		A:visited {color: Blue;}
	-->
	</style>
</head>
<body bgcolor="#000000" onload="document.login.login_username.focus()">
...
?>
	<table id="login" align="center">
		...
		<tr style="height:10px;"><td></td></tr>
		<tr id="login_row">
			<td colspan="2"><font color="#00a1d1">Please enter your login details below</font></td>
		</tr>
		<tr style="height:10px;"><td></td></tr>
		<tr id="user_row">
			<td><font color="#00a1d1">User Name:</font></td>
			<td><input type="text" name="login_username" size="40" style="width: 295px;" value="<?php print htmlspecialchars($username); ?>"></td>
		</tr>
		<tr id="password_row">
			<td><font color="#00a1d1">Password:</font></td>
