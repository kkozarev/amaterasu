...
<div id="content">
	...
	<div class="single">
		...
		<div style="padding:0 10px 40px">
			...
			Author: <span class="orange"><?php the_author() ?></span><span class="comm"><?php comments_popup_link('no comments', '1 comment', '% comments'); ?></span><?php the_tags(' | Tags: ', ', ', ''); ?><div class="clr"></div>
			</div>
