...
<div id="wrapper">
	...
	<div id="header">
		...
		<?php if (get_option('sg_logo')==''): ?>
			<a href="<?php echo get_option('home'); ?>" title="<?php bloginfo('name'); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/logo.png" alt="<?php bloginfo('description'); ?>" /></a>
		<?php else: ?>
			<a href="<?php echo get_option('home'); ?>" title="<?php bloginfo('name'); ?>"><img src="<?php echo stripslashes(get_option('sg_logo')); ?>" alt="<?php bloginfo('description'); ?>" /></a>
		<? endif; ?>
