var chart = spiralSegmentChart()
    ...
    .margin({top: 50, right: 0, bottom: 10, left: 220});
...
var months=chart.segmentLabels();
var years=chart.radialLabels();
var data = [];
var i;
...
d3.selectAll("#spiralchart path")
	...
	origCol = d3.select(this).style('fill');
	d3.select(this).style('fill','#fdcd68');})
    .on('mouseout', function() {
	d3.select("#info").text('');
	currentColor == "#fdcd68" ? origCol : "#0ab3ff";
